...
async def cmd_register(message: types.Message):
    await message.reply("Для регистрации в API Яндекс.Диска, перейди по ссылке и следуй инструкциям: <https://oauth.yandex.ru/verification_code#access_token=46b221caabf54035a189af015acac91b>")
